...
module "metadata" {
  ...
  market              = "us"
  project             = "https://github.com/LexisNexis-RBA/terraform-azurerm-sql-managed-instance"
  location            = "eastus2"
  environment         = "sandbox"
  product_name        = random_string.mi_name.result
  business_unit       = "infra"
...
module "sql_mi" {
  source = "https://github.com/faraday23/azurerm-sql-managed-instance.git?ref=sql-mi-3-30-21"
  ...
  sql_mi_settings = {
    ...
    backupShortTermRetentionPolicies  = "30"
    azureAdAdmin                      = ""
    ...
    # For SqlManagement_controlPlane_primary and SqlManagement_controlPlane_backup
